...
var SpaceTreeLog = {
  ...
  write: function(text){
    if (!this.elem) 
        this.elem = DOMCalls.spaceTreeLogElement; 
...
var SpaceTreeLabel = {
    ...
    addImagesCredits: function (label, node) {
        let url = "";
        let credit = "";
        let urlCredit = "";
        let creditEle = DOMCalls.authorCreditElement; 
        let visEle = DOMCalls.spaceTreeElement; 
        if (node.data.img) {
...
}  /* End of Class(Object) "SpaceTreeLabel" */
    ...
    createNewST: function(selectedNode,mode) {
        ...
        var monasticST = new $jit.ST({
            ...
            onCreateLabel: function(label, node){
                label = SpaceTreeLabel.addNamesStyles(label,node);
                label.onclick = function() {
                    SpaceTreeLabel.addImagesCredits(label, node);
